...
const Profile = () => {
  const aboutMe = `1997年4月9日生まれの28歳で、滋賀県で生まれ育ちました。\n京都外国語専門学校卒業後は、興味があったWEB制作を学ぶためにTECH::EXPERTにてプログラミングの学習をしました。\n現在は株式会社ニューコムの営業企画部のウェブ担当として、主にWEBサイトの情報更新やページ作成、既存ページのリニューアルを担当しています。その他、年に数回開催されている展示会で使用する各種資料の準備やWEBセミナーの配信業務なども担当しています。\n日々の業務では、初めての事であっても、自身の経験になると捉えて、取り組んでいます。`;
